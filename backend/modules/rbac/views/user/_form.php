...
<div class="form-box-dialog">
    ...
    <?= Html::img(@$model->head_pic, ['style'=>'margin-left:130px;margin-bottom:10px;','width'=>'30','height'=>'30','class'=>'layui-circle userinfo_head_pic'])?>
	<?= $form->field($model, 'head_pic',[
	        'template' => '{label}{input}<div class="layui-input-inline" style="width: 50px;"><button type="button" class="layui-btn layui-btn-primary upload_button" id="upload"><i class="layui-icon"></i>上传头像</button>{hint}</div>'
